...
echo "   # Optional: override the Bedrock model (default is Claude Haiku 4.5)"
echo "   # export TF_VAR_bedrock_model_id='anthropic.claude-haiku-4-5-20251001-v1:0'"
echo ""
echo "2. Make sure the Claude model is enabled in Bedrock for your account/region"
echo "   (AWS Console > Bedrock > Model access)"
echo ""
echo "3. Initialize and apply Terraform (use -upgrade if bumping provider from 5.x):"
echo "   cd terraform"
echo "   terraform init -upgrade"
echo "   terraform plan"
echo "   terraform apply"
echo ""
echo "4. Configure Slack with the API Gateway URL from terraform output"
